  ...
  return (
    <Stack>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Boolog, the software program
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Boolog.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Boolog, accessible from{" "}
            <a
              href="https://ericma.net"
      ...
      <ul>
        <li>By email: boolog-support@googlegroups.com</li>
      </ul>
    </Stack>
  );
};
